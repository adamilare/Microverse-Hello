...
**Microverse-Hello** is an introductory project in Microverse software development program.
...
- **Demonstrates use of GitHub flow**
- **Demonstrates Microverse project submission process**
- **Introduction to use of linters**
...
```sh
  cd my-folder
  git clone git@github.com:myaccount/microverse-hello.git
```
--->
